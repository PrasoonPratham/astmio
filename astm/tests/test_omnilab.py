...
class OmnilabTestCase(unittest.TestCase):
    def test_header_request(self):
        ...
        self.assertEqual(header.timestamp, datetime.datetime(2009, 11, 16, 10, 47, 31))
    ...
    def test_order_request(self):
        ...
        self.assertEqual(order.created_at, datetime.datetime(2001, 10, 23, 10, 57, 15))
        self.assertEqual(order.sampled_at, datetime.datetime(2001, 10, 23, 10, 57, 15))
    ...
    def test_result_request(self):
        ...
        self.assertEqual(
            result.completed_at, datetime.datetime(2009, 11, 16, 10, 47, 22)
        )
    ...
    def test_result_response(self):
        ...
        self.assertEqual(result.started_at, datetime.datetime(2010, 9, 26, 10, 0, 6))
        self.assertEqual(
            result.completed_at.labonline, datetime.datetime(2010, 9, 26, 10, 3, 4)
        )
        self.assertEqual(
            result.completed_at.analyzer, datetime.datetime(2010, 9, 26, 10, 3, 3)
        )
