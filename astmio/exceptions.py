...
class ProtocolError(BaseASTMError):
    ...
    def __init__(self, message: str, code: Optional[str] = None, 
                 protocol_data: Optional[bytes] = None, **kwargs):
        context = ErrorContext(
            operation="protocol_processing",
            data={
                'error_code': code,
                'protocol_data_length': len(protocol_data) if protocol_data else None,
                'protocol_data_preview': protocol_data[:100].hex() if protocol_data else None
            },
            suggestions=[
...
class ValidationError(BaseASTMError):
    ...
    def __init__(self, message: str, field: Optional[str] = None, 
                 value: Optional[Any] = None, constraint: Optional[str] = None, **kwargs):
        context = ErrorContext(
            operation="data_validation",
            data={
                'field': field,
...
class ConnectionError(BaseASTMError):
    ...
    def __init__(self, message: str, address: Optional[str] = None, 
                 port: Optional[int] = None, timeout: Optional[float] = None, **kwargs):
        context = ErrorContext(
...
class TimeoutError(ConnectionError):
    ...
    def __init__(self, message: str, operation: str = "connection", 
                 timeout_value: Optional[float] = None, **kwargs):
        context = ErrorContext(
...
class ParseError(BaseASTMError):
    ...
    def __init__(self, message: str, data: Optional[bytes] = None, 
                 position: Optional[int] = None, expected: Optional[str] = None, **kwargs):
        context = ErrorContext(
...
class ChecksumError(ProtocolError):
    ...
    def __init__(self, message: str, expected: Optional[str] = None, 
                 calculated: Optional[str] = None, data: Optional[bytes] = None, **kwargs):
        context = ErrorContext(
...
class Rejected(BaseASTMError):
    ...
    def __init__(self, message: str, attempts: Optional[int] = None, 
                 last_response: Optional[str] = None, **kwargs):
        context = ErrorContext(
...
class ErrorRecovery:
    ...
    @staticmethod
    def get_retry_delay(attempt: int, base_delay: float = 1.0, 
