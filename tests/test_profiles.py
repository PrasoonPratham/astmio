    ...
    def sample_profile(self):
        ...
        return {
            ...
            "records": {
                ...
                "L": {"fields": ["type", "sequence", "termination_code"]},
            },
            "parser": {
    ...
    def test_create_profile_from_scratch(self):
        ...
        new_profile = {
            ...
            "records": {
                ...
                "P": {"fields": ["type", "sequence", "patient_id"]},
                "O": {"fields": ["type", "sequence", "sample_id", "test"]},
                "R": {"fields": ["type", "sequence", "test", "value", "units"]},
                "L": {"fields": ["type", "sequence", "code"]},
            },
        }
