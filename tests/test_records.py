...
from astmio.records import (
    HeaderRecord as LegacyHeaderRecord,
    PatientRecord as LegacyPatientRecord,
    OrderRecord as LegacyOrderRecord,
    ResultRecord as LegacyResultRecord,
    CommentRecord as LegacyCommentRecord,
    TerminatorRecord as LegacyTerminatorRecord
)
from astmio import decode_record, encode_record
from astmio.mapping import Record, TextField, IntegerField, DateTimeField
...
class TestLegacyRecords:
    ...
    def test_legacy_header_encoding(self):
        ...
        header_data = ['H', ['', '^&'], None, 'PSWD', 'Maglumi User', 
                      None, None, None, None, 'Lis', None, 'P', 'E1394-97', '20250701']
    ...
    def test_legacy_order_encoding(self):
        ...
        order_data = ['O', '1', '25059232', None, ['^^^TT3 II', '^^^TT4 II', '^^^TSH II']]
    ...
    def test_legacy_result_encoding(self):
        ...
        result_data = ['R', '1', '^^^TT3 II', '1.171', 'ng/mL', '0.75 to 2.1', 'N',
                      None, None, None, None, None, '20250630151157']
...
class TestRecordDecoding:
    ...
    def test_decode_order_with_multiple_tests(self):
        ...
        # The repeat separators (\) create nested lists, components (^) separate within each repeat
